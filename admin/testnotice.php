                        ...
                        <div class="box box-primary">
                            ...
                            <form role="form" method="POST">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="odience">
                                            <option>Select Audience</option>
                                            <option value="All">All Students</option>
                                            <option value="Student">Co-ordinators</option>
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                try {
                                    ...
                                    $sql = "INSERT INTO notice(notice,audience,`date`) VALUES ('" . $notice . "', '" . $audience . "', now())";
